    ...
    return (
        <>
            ...
            <div className={styles.card_container_O}>
                {" "}
                {/*Cast-Card Outer Container */}
                <div className={styles.card_interact}>
                    {" "}
                    {/*Cast Interact Bar */}
                    <Box id={styles.drop_down}>
                        {" "}
                        {/*Cast sort-by dropdown menu */}
                        <FormControl>
                            <InputLabel id="sort-select-lebel">Sort</InputLabel>
                            <Select
                                labelId="sort-select-label"
                                id="sort-select"
                                onChange={handleSortCharge}
                                value={sortType}
                                label="Test"
                            >
                    ...
                    <Button
                        id={Expanded ? styles.card_button : styles.card_button_hidden}
                ...
                <div className={Expanded ? styles.card_container_I : styles.card_container_I_B}>
                    {" "}
                    {/*cast-card inner container */}
                    {sorted
